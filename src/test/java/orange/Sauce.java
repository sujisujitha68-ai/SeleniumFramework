...
public class Sauce {
	public static void main(String[] args) {
        ...
        WebElement dress=wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@data-test='inventory-item-name']")));
        dress.click();
        WebElement cart =wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[text()='Add to cart']")));
        cart.click();
        WebElement addcart =wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[@class='shopping_cart_badge']/parent::a")));
        addcart.click();
